        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900"
                     x-data="{
                         imagePreview: '{{ $galeri->tipe === 'gambar' && $galeri->gambar ? Storage::url($galeri->gambar) : '' }}',
                         tipe: '{{ old('tipe', $galeri->tipe) }}',
                         videoUrl: '{{ old('video_url', $galeri->video_url) }}'
                     }">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="tipe" value="gambar" x-model="tipe" @checked(old('tipe', $galeri->tipe) === 'gambar')
                                        ...
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="tipe" value="video" x-model="tipe" @checked(old('tipe', $galeri->tipe) === 'video')
                                                   class="rounded-full border-gray-300 text-orange-600 shadow-sm focus:ring-orange-500">
                            ...
                            <div class="space-y-4">
                                ...
                                <div x-show="tipe === 'gambar'">
                                    ...
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-sm text-gray-500">Kosongkan jika tidak ingin mengubah gambar. Format: JPG, PNG, JPEG, GIF, WEBP. Max: 2MB.</p>
                                </div>
