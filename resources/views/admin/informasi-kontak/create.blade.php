<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-sm sm:text-base md:text-2xl text-orange-600 tracking-tight flex items-center truncate">
            <span class="truncate">{{ __('Tambah Informasi Kontak') }}</span>
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.informasi-kontak.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="alamat" name="alamat" rows="3" required class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('alamat') @enderror">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="maps_url" name="maps_url" rows="3" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('maps_url') @enderror font-mono text-sm" placeholder="Link atau kode embed peta">{{ old('maps_url') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="telepon" name="telepon" required value="{{ old('telepon') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('telepon') @enderror" placeholder="0123-4567890">
                                    @error('telepon')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" required value="{{ old('email') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('email') @enderror" placeholder="email@bpbd.go.id">
                                    @error('email')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div id="jam-operasional-container">
                                        <div class="jam-operasional-item flex gap-2 mb-2">
                                            <input type="text" name="jam_operasional[]" value="{{ old('jam_operasional.0') }}" class="flex-1 rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500" placeholder="Senin - Jumat: 08:00 - 16:00 WIB">
                                            <button type="button" onclick="removeJamOperasional(this)" class="px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition hidden">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="url" id="facebook" name="facebook" value="{{ old('facebook') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('facebook') @enderror" placeholder="https://facebook.com/bpbd">
                                    @error('facebook')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="url" id="instagram" name="instagram" value="{{ old('instagram') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('instagram') @enderror" placeholder="https://instagram.com/bpbd">
                                    @error('instagram')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="url" id="twitter" name="twitter" value="{{ old('twitter') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('twitter') @enderror" placeholder="https://twitter.com/bpbd">
                                    @error('twitter')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="url" id="youtube" name="youtube" value="{{ old('youtube') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('youtube') @enderror" placeholder="https://youtube.com/@bpbd">
                                    @error('youtube')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp') }}" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 @error('whatsapp') @enderror" placeholder="628123456789">
