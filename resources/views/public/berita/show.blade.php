                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="border-b border-gray-200 pb-4 sm:pb-6 mb-6 sm:mb-8">
                        ...
                        <div class="mt-4 sm:mt-6 flex items-center space-x-3">
                            ...
                            <button onclick="copyToClipboard()" id="copyLinkBtn" class="group relative inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-500 hover:bg-gray-600 text-white transition-all duration-200 shadow-md hover:shadow-lg">
                                <span class="sr-only">Salin Link</span>
                                <svg id="linkIcon" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Toast Notification -->
                        <div id="copyNotification" class="fixed top-4 right-4 z-50 bg-green-500 text-white px-4 py-3 rounded-lg shadow-lg items-center space-x-3 hidden">
                    ...
                    <div class="prose prose-sm sm:prose-base lg:prose-lg prose-orange max-w-none select-none content-area" oncontextmenu="return false;" oncopy="return false;" oncut="return false;">
                        {!! clean($berita->konten) !!}
                    </div>
